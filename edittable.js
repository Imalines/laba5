...
var newColHtml = '<div class="btn-group pull-right">' +
    ...
    '</button>' +
    '<button id="bElim" type="button" class="btn btn-sm btn-success"  onclick="rowElim(this);">' +
    '<i class="fas fa-trash-alt" aria-hidden="true"></i>' +
    '</button>' +
    '<button id="bAcep" type="button" class="btn btn-sm btn-success"  style="display:none;" onclick="rowAcep(this);">' +
    '<i class="fas fa-tasks"></i>' +
    '</button>' +
    '<button id="bCanc" type="button" class="btn btn-sm btn-success" style="display:none;"  onclick="rowCancel(this);">' +
    '<i class="fas fa-undo" aria-hidden="true"></i>' +
    '</button>' +
    '</div>';

var saveColHtml = '<div class="btn-group pull-right">' +
    '<button id="bEdit" type="button" class="btn btn-sm btn-success" style="display:none;" onclick="rowEdit(this);">' +
    '<i class="fas fa-edit"></i>' +
    '</button>' +
    '<button id="bElim" type="button" class="btn btn-sm btn-success" style="display:none;" onclick="rowElim(this);">' +
    '<i class="fas fa-trash-alt" aria-hidden="true"></i>' +
    '</button>' +
    '<button id="bAcep" type="button" class="btn btn-sm btn-success"   onclick="rowAcep(this);">' +
    '<i class="fas fa-tasks"></i>' +
    '</button>' +
    '<button id="bCanc" type="button" class="btn btn-sm btn-success"  onclick="rowCancel(this);">' +
    '<i class="fas fa-undo" aria-hidden="true"></i>' +
    '</button>' +
    '</div>';
